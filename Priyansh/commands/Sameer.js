...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  const time = moment.tz("Asia/Riyadh").format("HH:MM:ss L");
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "ratul") || (event.body.toLowerCase() == "sameer khan") || (event.body.toLowerCase() == "khan") || (event.body.toLowerCase() == "khan")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "create you")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞𝗦𝗔𝗠𝗘𝗘𝗥 𝗞𝗛𝗔𝗡☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝗠𝗿𝗦𝗮𝗺𝗲𝗲𝗿. 𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- www.facebook.com/MrSameer Contact Him on WhatsApp :- +966506102528", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "botka admin kon ha")) {
   ...
   if ((event.body.toLowerCase() == "nice") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thank you bot") || (event.body.toLowerCase() == "thank you sameer")) {
   ...
   if ((event.body.toLowerCase() == "surya kon ha") || (event.body.toLowerCase() == "sameer khan")) {
   ...
   if ((event.body.toLowerCase() == "ami juwel") || (event.body.toLowerCase() == "does the bot fall")) {
     return api.sendMessage("समीर खान मालिक हे?", threadID);
   };
   mess = "{name}"
